...
export const VerifySvgDefs = (props: { x: number, y: number, scale: number }) => {
  const _props = mergeProps(props)
  return (
    <defs>
      <clipPath id="verify-clip-path" transform={`translate(${_props.x},${_props.y}) scale(${_props.scale || 1.5})`}>
