...
var ve = (e, t, s) => t in e ? Ae(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s;
var J = (e, t, s) => (ve(e, typeof t != "symbol" ? t + "" : t, s), s), W = (e, t, s) => {
  if (!t.has(e))
    throw TypeError("Cannot " + s);
};
var w = (e, t, s) => (W(e, t, "read from private field"), s ? s.call(e) : t.get(e)), j = (e, t, s) => {
  if (t.has(e))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(e) : t.set(e, s);
}, K = (e, t, s, n) => (W(e, t, "write to private field"), n ? n.call(e, s) : t.set(e, s), s);
const be = (e, t) => e === t, G = {
  equals: be
};
let re = ce;
...
var g = null;
let D = null, a = null, h = null, v = null, X = 0;
function oe(e, t) {
  const s = a, n = g, i = e.length === 0, r = i ? le : {
    owned: null,
    cleanups: null,
    context: null,
    owner: t === void 0 ? n : t
...
function _(e, t) {
  ...
  }, n = (i) => (typeof i == "function" && (i = i(s.value)), ue(s, i));
  return [Se.bind(s), n];
}
function Q(e, t, s) {
  const n = fe(e, t, !1, C);
...
function we(e, t, s) {
  re = Ee;
  const n = fe(e, t, !1, C);
  (!s || !s.render) && (n.user = !0), v ? v.push(n) : U(n);
}
function P(e) {
  if (a === null)
    return e();
...
function ue(e, t, s) {
  let n = e.value;
  return (!e.comparator || !e.comparator(n, t)) && (e.value = t, e.observers && e.observers.length && k(() => {
    for (let i = 0; i < e.observers.length; i += 1) {
      const r = e.observers[i], o = D && D.running;
      o && D.disposed.has(r), (o ? !r.tState : !r.state) && (r.pure ? h.push(r) : v.push(r), r.observers && ae(r)), o || (r.state = C);
    }
    if (h.length > 1e6)
      throw h = [], new Error();
  }, !1)), t;
...
function me(e, t, s) {
  ...
  try {
    ...
    return e.pure && (e.state = C, e.owned && e.owned.forEach(R), e.owned = null), e.updatedAt = s + 1, de(i);
  }
  (!e.updatedAt || e.updatedAt <= s) && (e.updatedAt != null && "observers" in e ? ue(e, n) : e.value = n, e.updatedAt = s);
}
function fe(e, t, s, n = C, i) {
  const r = {
    fn: e,
    state: n,
    updatedAt: null,
...
function M(e, t) {
  ...
  for (let s = 0; s < e.sources.length; s += 1) {
    ...
    if (n.sources) {
      const i = n.state;
      i === C ? n !== t && (!n.updatedAt || n.updatedAt < X) && z(n) : i === T && M(n, t);
    }
  }
}
function ae(e) {
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    s.state || (s.state = T, s.pure ? h.push(s) : v.push(s), s.observers && ae(s));
  }
}
function R(e) {
  let t;
...
function Be(e, t, s) {
  let n = s.length, i = t.length, r = n, o = 0, l = 0, f = t[i - 1].nextSibling, c = null;
  for (; o < i || l < r; ) {
    if (t[o] === s[l]) {
      o++, l++;
      continue;
    ...
    for (; t[i - 1] === s[r - 1]; )
      i--, r--;
    if (i === o) {
      const u = r < n ? l ? s[l - 1].nextSibling : s[r - l] : f;
      for (; l < r; )
      ...
      e.insertBefore(s[l++], t[o++].nextSibling), e.insertBefore(s[--r], u), t[i] = s[r];
    } else {
      if (!c) {
        c = /* @__PURE__ */ new Map();
        let d = l;
      ...
      if (u != null)
        if (l < u && u < r) {
          let d = o, p = 1, b;
          for (; ++d < i && d < r && !((b = c.get(t[d])) == null || b !== u + p); )
            p++;
          if (p > u - l) {
            const E = t[o];
            for (; l < u; )
              e.insertBefore(s[l++], E);
          } else
...
function _e(e, t, s, n = {}) {
  let i;
  return oe((r) => {
    i = r, t === document ? e() : m(t, e(), t.firstChild ? null : void 0, s);
  }, n.owner), () => {
    i(), t.textContent = "";
  };
}
function F(e, t, s) {
  ...
  }, r = t ? () => (n || (n = i())).cloneNode(!0) : () => P(() => document.importNode(n || (n = i()), !0));
  return r.cloneNode = r, r;
}
function Qe(e, t = window.document) {
  const s = t[ee] || (t[ee] = /* @__PURE__ */ new Set());
  for (let n = 0, i = e.length; n < i; n++) {
    const r = e[n];
    s.has(r) || (s.add(r), t.addEventListener(r, Oe));
  }
}
function y(e, t, s) {
...
function H(e, t, s, n, i) {
  ...
  if (e = o && s[0] && s[0].parentNode || e, r === "string" || r === "number")
    if (r === "number" && (t = t.toString()), o) {
      let l = s[0];
      l && l.nodeType === 3 ? l.data = t : l = document.createTextNode(t), s = B(e, s, n, l);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (I(l, t, s, i))
        return Q(() => s = H(e, l, s, n, !0)), () => s;
      if (l.length === 0) {
        if (s = B(e, s, n), o)
          return s;
      } else
        f ? s.length === 0 ? te(e, l, n) : Be(e, s, l) : (s && B(e), te(e, l));
      s = l;
    ...
    if (l instanceof Node)
      ...
      if (Array.isArray(l))
        ...
        if (n) {
          for (; typeof l == "function"; )
            l = l();
          i = I(e, Array.isArray(l) ? l : [l], Array.isArray(f) ? f : [f]) || i;
        } else
          e.push(l), i = !0;
      else {
        const c = String(l);
  ...
  if (t.length) {
    ...
    for (let o = t.length - 1; o >= 0; o--) {
      ...
      if (i !== l) {
        ...
        !r && !o ? f ? e.replaceChild(i, l) : e.insertBefore(i, s) : f && l.remove();
      } else
        r = !0;
    }
  } else
...
function je(e) {
  return Object.keys(e).reduce((s, n) => {
    const i = e[n];
    return s[n] = Object.assign({}, i), ge(i.value) && !Te(i.value) && !Array.isArray(i.value) && (s[n].value = Object.assign({}, i.value)), Array.isArray(i.value) && (s[n].value = i.value.slice(0)), s;
  }, {});
}
function Ne(e) {
  return e ? Object.keys(e).reduce((s, n) => {
    const i = e[n];
    return s[n] = ge(i) && "value" in i ? i : {
      value: i
    }, s[n].attribute || (s[n].attribute = Fe(n)), s[n].parse = "parse" in s[n] ? s[n].parse : typeof s[n].value != "string", s;
  }, {}) : {};
}
function Ve(e) {
...
function ke(e, t) {
  ...
  return Object.keys(t).forEach((i) => {
    ...
    o && (r.value = r.parse ? pe(o) : o), l != null && (r.value = Array.isArray(l) ? l.slice(0) : l), r.reflect && se(e, r.attribute, r.value), Object.defineProperty(e, i, {
      get() {
        return r.value;
      },
      set(f) {
        const c = r.value;
        r.value = f, r.reflect && se(this, r.attribute, r.value);
        for (let u = 0, d = this.__propertyChangedCallbacks.length; u < d; u++)
          this.__propertyChangedCallbacks[u](i, f, c);
      },
      enumerable: !0,
      configurable: !0
    });
  ...
  return class extends e {
    ...
    connectedCallback() {
      if (this.__initialized)
        return;
      this.__releaseCallbacks = [], this.__propertyChangedCallbacks = [], this.__updating = {}, this.props = ke(this, t);
      const i = Ve(this.props), r = this.Component, o = $;
      try {
        $ = this, this.__initialized = !0, ze(r) ? new r(i, {
          element: this
        }) : r(i, {
          element: this
        });
...
function He(e, t = {}, s = {}) {
  ...
  return (r) => {
    ...
    return o ? (o.prototype.Component = r, o) : (o = Me(n, Ne(t)), o.prototype.Component = r, o.prototype.registeredTag = e, customElements.define(e, o, i), o);
  };
}
function Le(e) {
...
function Xe(e) {
  return (t, s) => {
    ...
    return oe((i) => {
      const r = Le(t);
      n.addPropertyChangedCallback((l, f) => r[l] = f), n.addReleaseCallback(() => {
        n.renderRoot.textContent = "", i();
      });
      const o = e(r, s);
      return m(n.renderRoot, o);
    }, Ye(n));
  };
}
function Ue(e, t, s) {
  return arguments.length === 2 && (s = t, t = {}), He(e, t)(Xe(s));
}
const Re = /* @__PURE__ */ F('<svg><defs><clipPath id="verify-clip-path"><path d="m23.84 13.2202h-1.8838v-5.0828c0-1.3862-1.1374-2.5236-2.5236-2.5236h-5.0828v-1.9194c0-1.7417-1.4218-3.1634-3.1634-3.1634s-3.1634 1.4218-3.1634 3.1634v1.8838h-5.0828c-1.3862 0-2.5236 1.1374-2.5236 2.5236v4.834h1.8838c1.8838 0 3.4122 1.5284 3.4122 3.4122s-1.5284 3.4122-3.4122 3.4122h-1.8838v4.834c0 1.3862 1.1374 2.5236 2.5236 2.5236h4.834v-1.9194c0-1.8838 1.5284-3.4122 3.4122-3.4122s3.4122 1.5284 3.4122 3.4122v1.9194h4.7984c1.3862 0 2.5236-1.1374 2.5236-2.5236v-5.0828h1.9194c1.7417 0 3.1634-1.4218 3.1634-3.1634s-1.3862-3.1279-3.1634-3.1279zm0 0"></path></clipPath><filter id="verify-clip-filter"><feFlood flood-color="#FFF"></feFlood><feComposite in2="SourceAlpha" operator="out"></feComposite><feGaussianBlur stdDeviation="2" result="blur"></feGaussianBlur><feComposite operator="atop" in2="SourceGraphic"></feComposite><feDropShadow flood-opacity="0.5"></svg>', !1, !0), qe = ({
  x: e = 0,
  y: t = 0,
  scale: s = 1
}) => (() => {
  const n = Re(), i = n.firstChild, r = i.nextSibling, o = r.firstChild, l = o.nextSibling, f = l.nextSibling, c = f.nextSibling, u = c.nextSibling;
  return y(i, "transform", `translate(${e},${t}) scale(${s})`), y(u, "dx", 2), y(u, "dy", 2), n;
})(), Je = /* @__PURE__ */ F('<div class="verify-slide-box"><div class="verify-slide-control">'), De = ({
  ref: e,
  width: t,
  update: s
}) => {
  let n = {}, [i, r] = _(0), [o, l] = _(0), [f, c] = _(0), [u, d] = _(!0);
  Ce(() => {
    r(() => n ? n.getBoundingClientRect().width : 0);
  });
  const p = (S) => {
    let A = S.screenX - o(), O = t - i();
    A = A <= 0 ? 0 : A >= O ? O : A, c(() => A), s(A);
  }, b = (S) => {
    d(() => !1), window.removeEventListener("mouseup", b), window.removeEventListener("mousemove", p);
  }, E = (S) => {
    u() && l(() => S.screenX), window.addEventListener("mouseup", b), window.addEventListener("mousemove", p);
  };
  return e({
    resetSlide: () => {
      l(() => 0), c(() => 0), d(() => !0);
    ...
    const S = Je(), A = S.firstChild;
    A.$$mousedown = E;
    const O = n;
    return typeof O == "function" ? Pe(O, A) : n = A, Q((ye) => he(A, `transform: translate(${f()}px, 0)`, ye)), S;
  })();
};
Qe(["mousedown"]);
const Z = (e, t = 0) => {
  if (typeof e == "number")
    return e;
  {
    const s = Number(e.replace(/[^0-9.]/g, ""));
    return isNaN(s) ? t : s;
  }
}, $e = /* @__PURE__ */ F('<svg><foreignObject x="0" y="0"><div class="verify-background-image"></svg>', !1, !0), ne = ({
  src: e,
  width: t,
  height: s,
  repeat: n = !0,
  ...
  const r = $e(), o = r.firstChild;
  return y(r, "clip-path", i), Q((l) => {
    const f = Z(t), c = Z(s), u = `background-image: url(${e});${n === !1 ? "background-repeat: no-repeat" : ""}`;
    return f !== l._v$ && y(r, "width", l._v$ = f), c !== l._v$2 && y(r, "height", l._v$2 = c), l._v$3 = he(o, u, l._v$3), l;
  }, {
    _v$: void 0,
    _v$2: void 0,
    _v$3: void 0
...
`, ie = "data:image/png;base64,", Ze = /* @__PURE__ */ F('<div class="verify-container"><svg><rect x="0" clip-path="url(#verify-clip-path)" fill="#FFF"></rect><g filter="url(#verify-clip-filter)">'), We = /* @__PURE__ */ F("<style>"), Ke = ({
  ...
  return e({}), [t ? (() => {
    ...
    const u = Ze(), d = u.firstChild, p = d.firstChild, b = p.nextSibling;
    return y(d, "width", s), y(d, "height", n), m(d, N(qe, {
      x: i,
      y: r,
      scale: 1.5
    }), p), m(d, N(ne, {
      ...
      width: s,
      height: n
    }), p), y(p, "width", s), y(p, "height", n), m(b, N(ne, {
      src: ie,
      width: s,
      height: n,
      ...
      ref(E) {
        const q = o;
        typeof q == "function" ? q(E) : o = E;
      },
      get width() {
        return Z(s);
      },
      update: c
    }), null), Q(() => y(b, "transform", `translate(${l()}, 0)`)), u;
  })()];
};
var x, L, Y, V;
class tt {
  constructor({
    ...
    j(this, x, null);
    // Verify渲染
    j(this, L, () => this.root ? (w(this, x) && w(this, x).call(this), K(this, x, _e(w(this, V), this.root)), w(this, x)) : new Error("Verify need root Element"));
    // 注册web-component
    j(this, Y, (t) => {
      Ue(t, {}, w(this, V));
    });
    j(this, V, () => {
      ...
      return N(Ke, {
        ref(s) {
          const n = t.appRef;
          typeof n == "function" ? n(s) : t.appRef = s;
        },
        component: !0,
        get width() {
          return t.width;
    ...
    this.root = n, this.width = i, this.height = r, this.verifyX = o, this.verifyY = l, t ? w(this, Y).call(this, s) : w(this, L).call(this);
  }
}
x = new WeakMap(), L = new WeakMap(), Y = new WeakMap(), V = new WeakMap();
export {
  tt as Verify,
  tt as default
};
